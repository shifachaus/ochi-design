const Footer = () => {
  return (
    <footer className="w-full h-screen bg-zinc-900 px-10 pt-20 pb-10 font-Founders_Grotesk_X-Condensed">
      <div className="h-full flex flex-col justify-between w-full">
        <div className="flex gap-5 ">
          <div className="md:w-1/2">
            <div>
              <h4 className="text-[5vw]  font-semibold leading-none uppercase">
                Eye-
              </h4>
              <h4 className="text-[5vw]  font-semibold leading-none uppercase">
                Opening
              </h4>
              <h4 className="text-[5vw] font-semibold leading-none uppercase md:hidden">
                PRESENTATIONS
              </h4>

              <div className="flex justify-between gap-20  mt-10 md:hidden">
                <div className=" flex flex-col gap-1">
                  ...
                  {[
                    ...
                    return (
                      <a href="#" key={index} className=" text-md  font-light">
                        {item}
                      </a>
                    );
                  })}
        ...
        <div className=" flex flex-col end  md:flex-row md:justify-between gap-5 ">
          <span>
            <svg
              width="72"
              height="30"
          ...
          <p className="text-md font-light">© ochi design 2024. Legal Terms</p>
          <p className="text-md font-light">Website by Obys</p>
        </div>
      </div>
    </footer>
  );
