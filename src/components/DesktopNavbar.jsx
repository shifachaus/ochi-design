const DesktopNavbar = ({ setShowMenu }) => {
  return (
    <nav className="fixed z-[999] w-full px-10 py-6 font-['Neue_Montreal'] flex justify-between bg-[#00000001] backdrop-blur-md">
      <div className="">
        <svg
          width="72"
          height="30"
      ...
      <div onClick={() => setShowMenu(true)} className="md:hidden mt-3">
        <svg
          className=""
          width="24"
          height="9"
